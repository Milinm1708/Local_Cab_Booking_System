    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('offline', 'Offline'), ('available', 'Available'), ('busy', 'On a Ride')], default='offline', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vehicle_type', models.CharField(choices=[('mini', 'Mini (Hatchback)'), ('sedan', 'Sedan'), ('suv', 'SUV')], default='mini', max_length=10)),
                ('make_model', models.CharField(help_text='e.g. Maruti Swift', max_length=100)),
                ('color', models.CharField(max_length=40)),
                ('plate_number', models.CharField(max_length=20, unique=True)),
                ('year', models.PositiveSmallIntegerField(default=2020)),
                ('seats', models.PositiveSmallIntegerField(default=4)),
                ('driver', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='vehicle', to='accounts.driver')),
            ],
        ),
    ]
